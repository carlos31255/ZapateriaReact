// Página de visualización de ventas para vendedores (Solo Lectura)

import { useState, useEffect } from 'react';
import { usePedidos } from '../hooks';
import type { Pedido } from '../types';
import styles from './AdminVentasPage.module.css'; // Reutilizamos estilos del admin

export const VendedorVentasPage = () => {
    const { pedidos, loading, fetchPedidos, calcularEstadisticas } = usePedidos();
    ...
    const getEstadoBadgeClass = (estado: string) => {
        switch (estado) {
            ...
            case 'procesando': return styles.estadoProcesando;
    ...
    const getEstadoIcon = (estado: string) => {
        switch (estado) {
            ...
            case 'procesando': return 'bi-arrow-repeat';
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.header}>
                <div>
                    <h1>
                        <i className="bi bi-cart-check"></i> Visualización de Ventas
                    </h1>
                    <p className={styles.subtitle}>
                        Consulta el historial y estado de las ventas
                    </p>
                </div>
            </div>

            {/* Estadísticas (Solo visualización) */}
